...
class OutsideModel extends Model {
    ...
    protected $_validate = array(
        ...
        array('email','require','电子邮箱必填',1),
        array('address','require','单位地址必填',1),
        array('name','require','课题名称必填',1),
        array('w_name','require','校外指导老师姓名必填',1),
        array('w_sex','require','校外指导老师性别必选',1),
        array('w_degree','require','校外指导老师学位必填',1),
        array('w_zhicheng','require','校外指导老师职称必填',1),
        array('w_direction','require','校外指导老师研究方向必填',1),
        array('tea_number','require','校内指导老师必须',1),
        array('content','require','申请理由必须必填',1),
        array('content2','require','校外指导老师意见必填',1),     
        array('tea_name','require','指导老师必须',1),
