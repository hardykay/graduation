...
class InspectionController extends Controller {
    ...
    public function unfinished($dep,$page=0){
        ...
        //$this->assign('list', $result);
        $pageView = getPageHtml($page,$count,__ROOT__.'/Dean/Inspection/Unfinished/dep/'.$dep);
    ...
    public function excellent($dep,$option,$page=0){
        ...
        $this->assign('list',$result);
        //$this->assign('list', $result);
        $pageView = getPageHtml($page,$count,__ROOT__."/Dean/Inspection/Excellent/dep/{$dep}/option/{$option}");
        $this->assign('page',$pageView);
        $this->display();
    }
    /**
