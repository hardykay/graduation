...
<body>
	<table class="table panel-info" >
            <caption style="text-align: center"><a href="/graduation/Teacher/Alteration/Index">查看未审核的学生</a></caption>
		<thead>
			<tr class="success">
				<th>学号</th>
				<th>姓名</th>
		...
		<tbody>
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><a href="/graduation/Teacher/Alteration/Look/stu/<?php echo ($vo["stu_number"]); ?>">查看</a></td>
