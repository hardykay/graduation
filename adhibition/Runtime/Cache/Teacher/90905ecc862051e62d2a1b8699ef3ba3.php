...
<br>
<div class="maofu">
<form role="form" action="<?php echo U('Draft/Check');?>" method="post" enctype="multipart/form-data">
        <div class="panel panel-info">
            ...
            <div class="panel-body">
            	<ul class="list-group">
            		...
            		<li class="list-group-item"><b>专业：<?php echo (base64_decode($data["dep"])); ?></b></li>
            ...
            <div class="panel-body">
                <textarea name="pingyu" style="width: 100%;height: 300px;" ></textarea>
                    <input type="hidden" name="stu" value="<?php echo ($data["stu"]); ?>" >
                    <input type="hidden" name="top" value="<?php echo ($data["top"]); ?>" >
                    附件：<input type="file" name="file" style="display: inline-block">
                  ...
                  <div style="clear:both;width: 100%;">
                    <div class="shjg">
                      <label class="red ">
                       ...
                       <select name="audit">
                           <option selected = "selected"  value="1">通过
