...
<div class="container">
    ...
    <h3 style="text-align: center"><b>附件：<?php if(empty($gao["url"])): ?>无<?php else: ?><a target="_blank" href="/graduation/Home/Index/DowNotice/id/<?php echo ($gao["id"]); ?>">附件下载</a><?php endif; ?></b></h3>
