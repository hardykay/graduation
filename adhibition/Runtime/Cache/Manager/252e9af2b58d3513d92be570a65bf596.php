...
<div class="container">
   ...
   <div class="col-sm-2">
	<button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#college">添加学院</button>
   </div>
   <div class="col-sm-1"></div>
...
<div class="dtree">
	...
	<script type="text/javascript">
		...
		d.add(0,-1,'中国石油大学胜利学院');
                //学院
        <?php if(is_array($co)): $i = 0; $__LIST__ = $co;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>d.add(<?php echo ($v["dep_id"]); ?>,0,'<?php echo ($v["dep_name"]); ?><a style="float:right;margin-right:300px;" href="/graduation/Manager/Tree/DelColege/id/<?php echo ($v["dep_id"]); ?>"  onclick="return confirm(\'确认删除吗？\')"><span style="color:red" class="glyphicon glyphicon-remove"></span></a>');<?php endforeach; endif; else: echo "" ;endif; ?>
//专业
