...
<!--			<tr>
		...
		<tbody>
				...
				<td><?php echo ($vo["cou"]); ?></td>
                                <td><a  href="/graduation/Manager/Review/Student/dep/<?php echo ($dep); ?>/tea/<?php echo ($vo["tea_number"]); ?>/name/<?php echo (base64_encode($vo["name"])); ?>/num/<?php echo ($vo["cou"]); ?>">立即分配学生</td>
