        ...
        <form action="<?php echo U('RandomAllotReview/addTeacher');?>" method="post">
            ...
            <table class="table panel-info bshadow" >
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><a href="/graduation/Manager/RandomAllotReview/DeleteTeacher/id/<?php echo ($id); ?>/tea_number/<?php echo ($vo["tea_number"]); ?>" onclick="return confirm('确定删除“<?php echo ($vo["name"]); ?>”吗？')">删除</a></td>
